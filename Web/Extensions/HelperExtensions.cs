...
namespace Web.Extensions
{
    ...
    {
        public static string GetRegistrationCount(this Requirement helper)
        {
        ...
        public static MarkupString GetRegisteredMembers(this Requirement helper, IEnumerable<Member> members)
        {
